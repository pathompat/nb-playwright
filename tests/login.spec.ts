...
test('login user should shown error when fill uncomplete username', async ({ page }) => {
...
test('login user should shown error when fill uncomplete password', async ({ page }) => {
